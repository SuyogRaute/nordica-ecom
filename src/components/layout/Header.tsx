      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Proudly made text (Right side) */}
            <div className="flex flex-col items-end leading-tight text-right mr-2">
              <span className="text-[11px] sm:text-xs font-semibold text-foreground/80">
                Proudly made
              </span>
              <span className="text-[11px] sm:text-xs font-medium text-foreground/60">
                in North America
              </span>
            </div>
